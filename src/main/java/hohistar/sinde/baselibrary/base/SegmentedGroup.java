...
public class SegmentedGroup extends RadioGroup {
    ...
    public void setTintColor(int tintColor,int uncheckedTextColor, int checkedTextColor) {
        mTintColor = tintColor;
        mCheckedTextColor = checkedTextColor;
    ...
    Integer mCheckDrawable,mUnCheckDrawable;
    public void setStateDrawable(int unCheck,int check){
    ...
    public void updateBackground() {
        ...
        if (count > 1) {
            ...
            if (mCheckDrawable != null){
                updateBackground(getChildAt(0), mCheckDrawable, mUnCheckDrawable);
            }else {
            ...
            if (mCheckDrawable != null){
                updateBackground(getChildAt(count - 1),mCheckDrawable,mUnCheckDrawable);
            }else {
...
//                new int[]{Color.GRAY, mTintColor, Color.WHITE});
